# hwtype (test/UnitTests/test21)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (6 lines)   **Input:** t Giri
...
## What the test does
Program (`hwtype`) compiled with `clang -g -O0 -c -emit-llvm` (clang/LLVM 15.0.0),
...
`_test_logs/UnitTests_test21.log`:
...
exits 0 (PASS); the slicing stage prints `Start slicing Function:Instruction is defined as main:51`; and no `[GIRI] Abnormal termination` line appears in the captured log.
