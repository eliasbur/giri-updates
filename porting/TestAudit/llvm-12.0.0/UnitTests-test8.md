...
## Stage-by-stage output (honest harness, per-test `_test_logs/UnitTests_test8.log`)
...
No `[GIRI] Abnormal termination` marker. EXPECTED_EXIT=54; no `[GIRI] Abnormal` marker.
