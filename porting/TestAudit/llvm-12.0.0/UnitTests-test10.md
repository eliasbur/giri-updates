...
## Stage-by-stage output (honest harness, per-test `_test_logs/UnitTests_test10.log`)
...
No `[GIRI] Abnormal termination` marker. EXPECTED_EXIT=103 (strlen of `giri` result); no `[GIRI] Abnormal` marker.
