...
## Stage-by-stage output (honest harness, per-test `_test_logs/UnitTests_test11.log`)
...
No `[GIRI] Abnormal termination` marker. pthread test; EXPECTED_EXIT=52; no `[GIRI] Abnormal` marker.
