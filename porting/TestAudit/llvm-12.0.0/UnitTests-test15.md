...
## Stage-by-stage output (honest harness, per-test `_test_logs/UnitTests_test15.log`)
...
No `[GIRI] Abnormal termination` marker. EXPECTED_EXIT=31 (hanoi move count tail); no `[GIRI] Abnormal` marker.
