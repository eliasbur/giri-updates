...
## Stage-by-stage output (honest harness, per-test `_test_logs/UnitTests_test18.log`)
...
No `[GIRI] Abnormal termination` marker. EXPECTED_EXIT=12; no `[GIRI] Abnormal` marker.
