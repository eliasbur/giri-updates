# test8 (UnitTests/test8)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (4 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test8/Makefile`)
...
## What the test does
See `test/UnitTests/test8/README.md` (3.4-era, unchanged). Program (`ptr.c`) compiled with
...
evidence run log (`test/_test_logs/test8.log`, commit 74b870f):
