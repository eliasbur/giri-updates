# test9 (UnitTests/test9)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (5 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test9/Makefile`)
- **Criterion:** none (slices at the implicit criterion)
- **EXPECTED_EXIT:** -1 (default)   **EXIT_UNCHECKED:** 1
...
## What the test does
See `test/UnitTests/test9/README.md` (3.4-era, unchanged). Program (`forloop.c`) compiled with
...
evidence run log (`test/_test_logs/test9.log`, commit 74b870f):
