# test14 (UnitTests/test14)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (7 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test14/Makefile`)
...
## What the test does
See `test/UnitTests/test14/README.md` (3.4-era, unchanged). Program (`struct-ptr.c`) compiled with
...
evidence run log (`test/_test_logs/test14.log`, commit 74b870f):
