# test16 (UnitTests/test16)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (7 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test16/Makefile`)
...
## What the test does
See `test/UnitTests/test16/README.md` (3.4-era, unchanged). Program (`calc.c + struct-ptr.c (llvm-linked)`) compiled with
...
evidence run log (`test/_test_logs/test16.log`, commit 74b870f):
