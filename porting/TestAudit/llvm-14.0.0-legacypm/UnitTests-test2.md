# test2 (UnitTests/test2)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (4 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test2/Makefile`)
...
## What the test does
See `test/UnitTests/test2/README.md` (3.4-era, unchanged). Program (`ifelse.c`) compiled with
...
evidence run log (`test/_test_logs/test2.log`, commit 74b870f):
