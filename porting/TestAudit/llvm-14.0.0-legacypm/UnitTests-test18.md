# test18 (UnitTests/test18)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (4 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test18/Makefile`)
...
## What the test does
See `test/UnitTests/test18/README.md` (3.4-era, unchanged). Program (`extlibcalls.c`) compiled with
...
evidence run log (`test/_test_logs/test18.log`, commit 74b870f):
