# test11 (UnitTests/test11)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (7 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test11/Makefile`)
...
## What the test does
See `test/UnitTests/test11/README.md` (3.4-era, unchanged). Program (`hello2p.c`) compiled with
...
evidence run log (`test/_test_logs/test11.log`, commit 74b870f):
