# test10 (UnitTests/test10)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (4 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test10/Makefile`)
...
## What the test does
See `test/UnitTests/test10/README.md` (3.4-era, unchanged). Program (`str.c`) compiled with
...
evidence run log (`test/_test_logs/test10.log`, commit 74b870f):
