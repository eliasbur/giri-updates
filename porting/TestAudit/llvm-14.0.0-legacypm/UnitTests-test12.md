# test12 (UnitTests/test12)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (20 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test12/Makefile`)
...
## What the test does
See `test/UnitTests/test12/README.md` (3.4-era, unchanged). Program (`psum.c`) compiled with
...
evidence run log (`test/_test_logs/test12.log`, commit 74b870f):
