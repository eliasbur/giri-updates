# test3 (UnitTests/test3)

- **Verdict:** CLEAN
- **Golden file:** ans-inst.txt (9 lines)   **Input:** (see per-test `INPUT` in `test/UnitTests/test3/Makefile`)
...
## What the test does
See `test/UnitTests/test3/README.md` (3.4-era, unchanged). Program (`fibonacci.c`) compiled with
...
evidence run log (`test/_test_logs/test3.log`, commit 74b870f):
