...
## What the test does
Program (`hanoi`) compiled with `clang -g -O0 -c -emit-llvm -Xclang -no-opaque-pointers`
...
`_test_logs/test15.log` (see the per-test log under `_test_logs/`).
