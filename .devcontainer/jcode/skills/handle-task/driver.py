...
docs/TaskNotes/Tasks/*.md note: figuring out which repo it belongs to,
...
TASKS_DIR = REPO_ROOT / "docs" / "TaskNotes" / "Tasks"
...
def main():
    ...
    def common(p):
        p.add_argument("task",
                       help="task note path, filename, or slug under docs/TaskNotes/Tasks/")
